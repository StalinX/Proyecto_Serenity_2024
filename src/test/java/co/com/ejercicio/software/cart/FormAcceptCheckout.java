...
public class FormAcceptCheckout {
    ...
    public static By CONTINUE_SHOPPING= By.id("button-guest");

   // public static By COMENTARY = By.name("comment");
    public static By CONTINUE_SHOPPING1= By.xpath("//input[@id='button-shipping-method']");
    public static By CONTINUE_SHOPPING2= By.xpath("//input[@id='button-payment-method']");
